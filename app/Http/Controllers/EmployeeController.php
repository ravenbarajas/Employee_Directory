...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $employee = Employee::create([
            ...
            'empHomeaddress' => $request->input('empHomeaddress'),
            ...
            'empCompanyaddress' => $request->input('empCompanyaddress'),
        ...
        try {
            ...
            foreach ($tableData as $rowData) {
                ...
                $employee = Employee::updateOrCreate(['empID' => $empID], [
                    ...
                    'empHomeaddress' => $rowData['empHomeaddress'],
                    'empMaritalstatus' => $rowData['empMaritalstatus'],
                    'empNationality' => $rowData['empNationality'],
                    'empReligion' => $rowData['empReligion'],
                    'empStatus' => $rowData['empStatus'],
                    'empCompany' => $rowData['empCompany'],
                    'empCompanyaddress' => $rowData['empCompanyaddress'],
